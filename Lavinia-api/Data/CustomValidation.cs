...
namespace LaviniaApi.Data
{
    public static class CustomValidation
    {
        ...
        public static void ValidateCountry(Country country, HashSet<int> checkedModels)
        {
            ...
            if (country.CountryCode == null) throw new ArgumentException("Country.ShortName cannot be null.");
        ...
        {
            if (county == null) throw new ArgumentException("County cannot be null.");

            if (county.Name == null) throw new ArgumentException("County.Name cannot be null.");
            if (county.Name.Length < 2) throw new ArgumentException("County.Name cannot be shorter than 3 characters.");
            if (county.Seats == -1) throw new ArgumentException("County.Seats cannot be the default value.");
        ...
        {
            if (countyData == null) throw new ArgumentException("CountyData cannot be null.");

            if (countyData.Year == -1) throw new ArgumentException("CountyData.Year cannot be the default value.");
            if (countyData.Population == -1)
                throw new ArgumentException("CountyData.Population cannot be the default value.");
            if (double.IsNaN(countyData.Areal)) throw new ArgumentException("CountyData.Areal cannot be null.");
        ...
        {
            if (election == null) throw new ArgumentException("Election cannot be null.");
            if (election.Year == -1) throw new ArgumentException("Election.Year cannot be the default value.");
            ...
            if (double.IsNaN(election.Threshold)) throw new ArgumentException("Election.Threshold cannot be null.");
            if (election.Seats == -1) throw new ArgumentException("Election.Seats cannot be the default value.");
        ...
        {
            if (electionType == null) throw new ArgumentException("ElectionType cannot be null.");
        ...
        {
            if (party == null) throw new ArgumentException("Party cannot be null.");

            if (party.Name == null) throw new ArgumentException("Party.Name cannot be null.");
            if (party.Name.Length < 2) throw new ArgumentException("Party.Name cannot be shorter than 3 characters.");
        ...
        {
            if (result == null) throw new ArgumentException("Result cannot be null.");

            if (result.PartyName == null) throw new ArgumentException("Party.Name cannot be null.");
            if (result.PartyName.Length < 2)
                throw new ArgumentException("Party.Name cannot be shorter than 3 characters.");
            if (result.PartyCode == null) throw new ArgumentException("Party.Name cannot be null.");
            if (result.PartyCode.Length < 1)
                throw new ArgumentException("Party.Name cannot be shorter than 3 characters.");
            if (result.Votes == -1) throw new ArgumentException("Result.Votes cannot be the default value.");
