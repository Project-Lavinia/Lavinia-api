...
void publishArtifact() {
    ...
    sh "curl -XPOST -H 'Authorization:token ${GITHUB_TOKEN}' -H 'Content-Type:application/octet-stream' --data-binary @artifact.zip https://uploads.github.com/repos/Project-Lavinia/Lavinia-api/releases/${release_id_str}/assets?name=artifact.zip"
}